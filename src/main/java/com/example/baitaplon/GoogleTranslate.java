...
//	}
	...
	public static String[] translate(String sourceLanguage , String targetLanguage , String text) throws IOException {
		...
		if (arr.length() > 2 && arr.get(2) instanceof String) {
			languageFound = arr.getString(2);
			System.out.println(languageFound);
		}
		...
		return new String[] {trans.toString(),languageFound};
	}
